...
<section class="section panel" id="sources"><h2>Official requirements / 官方要求</h2><p>规则核查：2026-09-13。当前依据Fall 2023 CED/Student Handouts和Summer 2026 Digital Portfolio指南，为2027年考试准备；正式实施前复核当年度文件。</p><p><strong>2027年4月30日23:59 ET：</strong>Create最终提交截止。<strong>2027年5月14日：</strong>AP CSP考试（Session 1）。校内里程碑另定；非传统课堂学生与学校/考点AP协调员确认安排。</p><ul>'''+sources+'''</ul></section><p class="minor"><a href="Chapter_6.html">← 第六章</a> · <a href="Chapter_8.html">第八章：综合复习与考试准备 →</a> · <a href="https://github.com/wenatnyu/ap-csp-2027/archive/refs/heads/main.zip">下载当前全部资料</a></p>'''
