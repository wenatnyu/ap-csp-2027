...
with ZipFile(ROOT/'AP_CSP_Chapters_1_2_3_Teaching_Pack.zip','w',ZIP_DEFLATED,compresslevel=6) as archive:
    for path in sorted(set(paths)):
        archive.write(path,'AP_CSP_Chapters_1_2_3/'+path.relative_to(ROOT).as_posix())
print('Built complete Chapters 1–3 teaching pack')
